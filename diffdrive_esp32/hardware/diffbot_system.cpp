...
hardware_interface::return_type diffdrive_esp32 ::DiffDriveArduinoHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  if (!comms_.connected())
  {
...
PLUGINLIB_EXPORT_CLASS(
  diffdrive_esp32::DiffDriveArduinoHardware, hardware_interface::SystemInterface)
